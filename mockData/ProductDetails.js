...
import OdoraDo from "@/assets/odora/Odora-do.jpg";
import OdoraXanh from "@/assets/odora/Odora-xanh.jpg";
import OdoraXanhNhat from "@/assets/odora/Odora-xanhNhat.jpg";
import OdoraDen from "@/assets/odora/Odora-den.jpg";
import OdoraDenNham from "@/assets/odora/Odora-denNham.jpg";
import OdoraTrang from "@/assets/odora/Odora-trang.jpg";
import OdoraXam from "@/assets/odora/Odora-S1-w300.png";
...
export const ProductDetails = [
  ...
  {
    id: "",
    name: "Xe Máy Điện Yadea ODORA S1",
    describe: {
      kichThuot: { daiXrongXcao: "1810x670x1120 mm", khoangSangGamXe: "165 mm", chieuCaoYen: "760 mm", dungTichCopXe: "15L", khoiLuong: "94kg" },
      dongCo: { congSuatDinhDanh: "600W", congSuatToiDa: "1500w", tocDoToiDa: "43km/h" },
      acQuy: { loaiAcquy: "Ắc quy Graphene TTFAR", dungLuongAcQuy: "60V22Ah", doDaiQuangDuong: "80km" },
      thongSoKhac: { heThongPhanh: "Đĩa/ tăng trống", thongSoLop: "Lốp không săm, Trước 100/90-10, Sau 100/90-10", heThongDen: "Full LED", heThongThongMinh: "Tìm xe, chống trộm khóa bánh" },
    },
    img:
      { xanh: OdoraXanh, xanhNhat: OdoraXanhNhat, do: OdoraDo, trang: OdoraTrang, den: OdoraDen, denNham: OdoraDenNham, xam: OdoraXam },
    imgDetails: [
      {
        title: "Kích thước tổng thể đạt 1.924 x 660 x1.138 mm (dài x rộng x cao), thông số này không quá chênh lệch với đối thủ Feliz S (1.912 x 693 x 1.128 mm). Voltguard mang thiết kế tương tự các dòng xe tay ga phổ thông.",
        src: VoltGuardDetail1
