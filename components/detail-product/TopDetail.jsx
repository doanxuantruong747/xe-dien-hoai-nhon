...
export const TopDetail = ({ product }) => {
 const [color, setColor] = useState(product?.img?.do)
 const { kichThuot, dongCo, acQuy, thongSoKhac } = product?.describe
 ...
 const tabs = [
  ...
  {
   title: (<h1 className='text-[15px] font-bold'>THÔNG SỐ KHÁC</h1>), content: (<><h3 className=' font-bold'>Hệ thống phang : <span className=' font-medium'>{thongSoKhac?.heThongPhanh}</span></h3>
 ...
 return (
  <div className=' flex lg:flex-row flex-col lg:justify-around justify-center w-full'>
